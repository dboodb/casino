...
bot = telebot.TeleBot('1593603184:AAEB-kDhhFAZdyaLKTlv-Oah88TDMq-YYtI') # Токен бота воркеров

admin = 157766707 # ID Админа
support = 157766707 # ID сапорта
channel_id = -1001239801307 # ID Канала залётов
chat_worker_id = -1001302720793 # ID Чата с воркерами

bot_name = '' # @workersplayfortuna_bot

mater = '' # https://vk.com/crckhead
zalet = '' # https://t.me/zaletyyy
infos = '' # https://t.me/pfortuna_news
pname = '' # PlayFortuna
pdate = '' # 29.05.2010
