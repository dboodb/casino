...
tickets = '1593603184:AAEB-kDhhFAZdyaLKTlv-Oah88TDMq-YYtI' # TOKEN Бота воркера
bot = telebot.TeleBot('1538419267:AAF1h-o4LIGULI1mJ4IAshoN10WWxq6hLEY') # TOKEN Бота казино

admin = 157766707 # ID Админа
support_id = 157766707 # ID Саппорта
channel_id = -1001239801307 # ID Канала с вылатами
support = 'poka_zhiv' # Username Сапорта

phone = '' # 79502764536
token = '' # b3115e81a4d507bec5b9690f8be5bb6e
